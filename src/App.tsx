...
const products =[
  {
    ...
    price: 34.99,
    originalPrice: 49.99,
    image: "${BASE}/images/tshirt-1.png",
    tag: "Bestseller",
    category: "Graphic",
    sizes: ["XS", "S", "M", "L", "XL"],
  ...
  },
  {
    ...
    price: 38.99,
    originalPrice: 54.99,
    image: "${BASE}/images/tshirt-2.png",
    tag: "New",
    category: "Y2K",
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    price: 32.99,
    originalPrice: 44.99,
    image: "${BASE}/images/tshirt-3.png",
    tag: "Limited",
  ...
  },
  {
    ...
    price: 36.99,
    originalPrice: 52.99,
    image: "${BASE}/images/tshirt-4.png",
    tag: "Hot",
    category: "Y2K",
    sizes: ["XS", "S", "M", "L", "XL"],
  ...
  },
  {
    ...
    price: 33.99,
    originalPrice: 47.99,
    image: "${BASE}/images/tshirt-5.png",
    tag: "New",
    category: "Retro",
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    price: 35.99,
    originalPrice: 49.99,
    image: "${BASE}/images/tshirt-6.png",
    tag: "Trending",
    category: "Tie-Dye",
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="aspect-[3/4] rounded-2xl overflow-hidden bg-[#edeae4]">
                <img src="${BASE}/images/hero-tshirt.png" alt="Hero T-shirt" className="w-full h-full object-cover" />
              </div>
              {/* Floating label */}
        ...
        <div className="max-w-6xl mx-auto px-6 py-24">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="aspect-[4/5] rounded-2xl overflow-hidden bg-[#edeae4]">
              <img src="${BASE}/images/IMG_0079.jpeg" alt="About" className="w-full h-full object-cover" />
            </div>
